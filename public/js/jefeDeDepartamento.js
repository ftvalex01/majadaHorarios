...
document.addEventListener("DOMContentLoaded", async function () {
    ...
    try {
        ...
        const response = await fetch(
            `https://majadahorarios-app.onrender.com/api/v1/user`,
            {
                method: "GET",
                headers: {
        ...
        const profesoresMismoDepartamento = profesoresData.data.filter(
            (profesor) =>
                profesor.departamento_id === idDepartamentoUsuarioLoggeado
        );
        ...
        function crearTarjetaProfesor(profesor) {
            ...
            card.querySelector(".ver-detalles").dataset.profesor =
                detallesProfesor;
        ...
        profesoresMismoDepartamento.forEach((profesor) => {
            ...
            tarjetaProfesor
                ...
                .addEventListener("click", async function () {
                    ...
                    try {
                        const response = await fetch(
                            `https://majadahorarios-app.onrender.com/api/v1/departamentos/${idDepartamentoUsuarioLoggeado}/profesores/${profesorId}/modulos`,
                            {
                                method: "GET",
                                headers: {
                                    "Content-Type": "application/json",
